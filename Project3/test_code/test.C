...
//			cout << operName << endl;
	...
	while (iFile) {
		...
		cout << "creature[" << i << "]: " << " " << /*world.creatures[i].species->name << " " <<*/ directName[world.creatures[i].direction].c_str() << " " << world.creatures[i].location.r << " " << world.creatures[i].location.c << endl;
